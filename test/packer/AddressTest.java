...
public class AddressTest {
    ...
    public void testToString() {
        ...
        assertEquals("1 First StAplaceCitadel CityA111", testAddress1.toString());
        assertEquals("123 Count StBrooklynWelling TownB222", testAddress2.toString());
        assertEquals("321 Back StChristlyHolly OaksC333", testAddress3.toString());
    }
