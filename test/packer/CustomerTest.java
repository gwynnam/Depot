...
public class CustomerTest {
    ...
    public void testGetClosestAddressTo() {
        ...
        /**
         * Testing the closest address to Address 3
         */
        ...
        assertEquals(testAddress0, testCustomer.getClosestAddressTo(testDepot4));
        
        /**
         * Testing the closest address to Address 1
         */
        ...
        assertEquals(testAddress4, testCustomer.getClosestAddressTo(testDepot0));
        assertEquals(testAddress4, testCustomer.getClosestAddressTo(testDepot4));
        
        /**
         * Testing the closest address to Address 2
         */
